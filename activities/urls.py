...
urlpatterns = [
    ...
    path('profile/<int:user_id>/', views.profile, name='user_profile'),  # URL pour voir le profil d'un utilisateur
    ...
    path('test-500-real/', views.test_500_real, name='test_500_real'),
